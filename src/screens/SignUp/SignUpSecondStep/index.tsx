      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <Container>
          ...
          <Form>
            ...
            <InputPassword placeholder="Senha" iconName="lock" onChangeText={setPassword} value={password}/>
            <InputPassword placeholder="repetir Senha" iconName="lock" onChangeText={setConfirmPassword} value={confirmPassword}/>
